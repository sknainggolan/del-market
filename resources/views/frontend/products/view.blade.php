                ...
                <div class="col-md-8">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-9">
                            <br/>
                            @if ($products->qty > 0)
                            <button type="button" class="btn btn-success me-3 addToCartBtn float-start">Add to Cart <i class="fa fa-heart"></i></button>
                            @endif
                            <button type="button" class="btn btn-primary me-3 float-start">Add to Wishlist <i class="fa fa-shopping-cart"></i></button>
                        </div>
                    </div>
                </div>
            </div>
